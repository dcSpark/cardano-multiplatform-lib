...
#[cfg(test)]
mod tests {
    use cml_chain::plutus::{CostModels, Language};
    ...
    fn tx_builder_config_from_json() {
        ...
        assert_eq!(
            *config
                .cost_models
                .inner
                .get(&Language::PlutusV1.into())
                .unwrap(),
            plutus_v1_cost_models
        );
        assert_eq!(
            *config
                .cost_models
                .inner
                .get(&Language::PlutusV2.into())
                .unwrap(),
            plutus_v2_cost_models
        );
        assert_eq!(
            *config
                .cost_models
                .inner
                .get(&Language::PlutusV3.into())
                .unwrap(),
            plutus_v3_cost_models[..CostModels::PLUTUS_V3_COUNT]
        );
    }
}
