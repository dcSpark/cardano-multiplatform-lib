                        ...
                        reference_inputs
                            ...
                            .fold(&mut languages, |langs, input| {
                                if let Some(script_ref) = &input.output.script_ref()
                                    && let Some(lang) = script_ref.get().language()
                                {
                                    langs.insert(lang);
                                }
                                langs
...
mod tests {
    ...
    fn native_ref_script_size_does_not_panic() {
        ...
        assert_eq!(ref_script_orig_size(&script_ref.into()), expected_size);
    }
