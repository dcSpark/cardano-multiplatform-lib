                    ...
                    if let Some(field) = &self.key_0 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_0_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                        ...
                        let mut key_order = field
                            ...
                            .map(|(k, v)| {
                                ...
                                let key_0_key_encoding = self
                                    .encodings
                                    .as_ref()
                                    .and_then(|encs| encs.key_0_key_encodings.get(k))
                                    .map(|e| e.clone())
                                    .unwrap_or_else(|| None);
                                buf.write_unsigned_integer_sz(
                                    *k,
                                    fit_sz(*k, key_0_key_encoding, force_canonical),
                                )?;
                                Ok((buf.finalize(), k, v))
                            })
                    ...
                    if let Some(field) = &self.key_1 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_1_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_2 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_2_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                        ...
                        for (i, element) in field.iter().enumerate() {
                            let key_2_elem_encoding = self
                                .encodings
                                .as_ref()
                                .and_then(|encs| encs.key_2_elem_encodings.get(i))
                                .map(|e| e.clone())
                                .unwrap_or_else(|| StringEncoding::default());
                    ...
                    if let Some(field) = &self.key_3 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_3_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                        ...
                        for (i, element) in field.iter().enumerate() {
                            let key_3_elem_encoding = self
                                .encodings
                                .as_ref()
                                .and_then(|encs| encs.key_3_elem_encodings.get(i))
                                .map(|e| e.clone())
                                .unwrap_or_else(|| StringEncoding::default());
                            serializer.write_bytes_sz(
                                &element,
...
impl Deserialize for AlonzoAuxData {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let mut read = 0;
            while match len {
                cbor_event::LenSz::Len(n, _) => read < n as usize,
                ...
                match raw.cbor_type()? {
                    CBORType::UnsignedInteger => match raw.unsigned_integer_sz()? {
                        (0, key_enc) => {
                            ...
                            let (tmp_key_0, tmp_key_0_encoding, tmp_key_0_key_encodings) =
                                (|| -> Result<_, DeserializeError> {
                                    ...
                                    let mut key_0_key_encodings = BTreeMap::new();
                                    while match key_0_len {
                                        cbor_event::LenSz::Len(n, _) => {
                                            key_0_table.len() < n as usize
                                        }
                                        cbor_event::LenSz::Indefinite => true,
                                    } {
                                        ...
                                        let (key_0_key, key_0_key_encoding) = raw
                                            .unsigned_integer_sz()
                                            .map(|(x, enc)| (x, Some(enc)))?;
                                        let key_0_value = TransactionMetadatum::deserialize(raw)?;
                                        if key_0_table
                                            .insert(key_0_key.clone(), key_0_value)
                                            .is_some()
                                        {
                                        ...
                                        key_0_key_encodings
                                            .insert(key_0_key.clone(), key_0_key_encoding);
                                    }
                        ...
                        (2, key_enc) => {
                            ...
                            let (tmp_key_2, tmp_key_2_encoding, tmp_key_2_elem_encodings) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    ...
                                    while match len {
                                        ...
                                        let (key_2_elem, key_2_elem_encoding) =
                                            raw.bytes_sz().map(|(bytes, enc)| {
                                                (bytes, StringEncoding::from(enc))
                                            })?;
                        ...
                        (3, key_enc) => {
                            ...
                            let (tmp_key_3, tmp_key_3_encoding, tmp_key_3_elem_encodings) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    ...
                                    while match len {
                                        ...
                                        let (key_3_elem, key_3_elem_encoding) =
                                            raw.bytes_sz().map(|(bytes, enc)| {
                                                (bytes, StringEncoding::from(enc))
                                            })?;
...
impl Deserialize for AlonzoTxOut {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let datum_hash =
                (|| -> Result<_, DeserializeError> { Ok(DataHash::deserialize(raw)?) })()
            ...
            Ok(AlonzoTxOut {
                ...
                amount,
                datum_hash,
                encodings: Some(AlonzoTxOutEncoding { len_encoding }),
            })
        })()
    ...
    fn serialize<'se, W: Write>(
        ...
        match self {
            AuxiliaryData::ShelleyAuxData {
                ...
                serializer.write_map_sz(
                    shelley_aux_data_encoding
                        .to_len_sz(shelley_aux_data.len() as u64, force_canonical),
                )?;
                let mut key_order = shelley_aux_data
                    .iter()
                    .map(|(k, v)| {
                        let mut buf = cbor_event::se::Serializer::new_vec();
                        let shelley_aux_data_key_encoding = shelley_aux_data_key_encodings
                            .get(k)
                            .map(|e| e.clone())
                            .unwrap_or_else(|| None);
                        buf.write_unsigned_integer_sz(
                            *k,
                            fit_sz(*k, shelley_aux_data_key_encoding, force_canonical),
                        )?;
                        Ok((buf.finalize(), k, v))
                    })
                    .collect::<Result<Vec<(Vec<u8>, &_, &_)>, cbor_event::Error>>()?;
    ...
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                ...
                while match shelley_aux_data_len {
                    cbor_event::LenSz::Len(n, _) => shelley_aux_data_table.len() < n as usize,
                    cbor_event::LenSz::Indefinite => true,
                } {
                    if raw.cbor_type()? == CBORType::Special {
                        assert_eq!(raw.special()?, CBORSpecial::Break);
                    ...
                    let (shelley_aux_data_key, shelley_aux_data_key_encoding) =
                        raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?;
                    let shelley_aux_data_value = TransactionMetadatum::deserialize(raw)?;
                    if shelley_aux_data_table
                        .insert(shelley_aux_data_key.clone(), shelley_aux_data_value)
                        .is_some()
                    {
                    ...
                    shelley_aux_data_key_encodings
                        .insert(shelley_aux_data_key.clone(), shelley_aux_data_key_encoding);
                }
                Ok((
                    shelley_aux_data_table,
                    shelley_aux_data_encoding,
                    shelley_aux_data_key_encodings,
                ))
            })(raw)
                    ...
                    if let Some(field) = &self.key_3 {
                        ...
                        serializer.write_tag_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_3_tag_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                        let mut key_3_inner_se = Serializer::new_vec();
                        key_3_inner_se.write_bytes_sz(
                            &field,
                            self.encodings
                                .as_ref()
                                .map(|encs| encs.key_3_encoding.clone())
                        ...
                        serializer.write_bytes_sz(
                            ...
                            self.encodings
                                .as_ref()
                                .map(|encs| encs.key_3_bytes_encoding.clone())
                                .unwrap_or_default()
                                .to_str_len_sz(key_3_bytes.len() as u64, force_canonical),
                        )?;
                    }
                }
                _ => unreachable!(),
                ...
                match raw.cbor_type()? {
                    CBORType::UnsignedInteger => match raw.unsigned_integer_sz()? {
                        ...
                        (3, key_enc) => {
                            ...
                            let (
                                tmp_key_3,
                                tmp_key_3_tag_encoding,
                                tmp_key_3_bytes_encoding,
                                tmp_key_3_encoding,
                            ) = (|| -> Result<_, DeserializeError> {
                                read_len.read_elems(1)?;
                                Ok(match raw.tag_sz()? {
                                    (24, tag_enc) => {
                                        ...
                                        let mut inner_de = &mut Deserializer::from(
                                            std::io::Cursor::new(key_3_bytes),
                                        );
                                        inner_de.bytes_sz().map(|(bytes, enc)| {
                                            (
                                                bytes,
                                                Some(tag_enc),
                                                StringEncoding::from(key_3_bytes_encoding),
                                                StringEncoding::from(enc),
                                            )
                                        })?
                                    }
                                    (tag, _enc) => {
...
impl Serialize for Block {
    fn serialize<'se, W: Write>(
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.transaction_bodies_encoding.clone())
                .unwrap_or_default()
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.transaction_witness_sets_encoding.clone())
                .unwrap_or_default()
        ...
        serializer.write_map_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.auxiliary_data_set_encoding.clone())
                .unwrap_or_default()
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.invalid_transactions_encoding.clone())
                .unwrap_or_default()
...
impl Deserialize for Certificate {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let initial_position = raw.as_mut_ref().seek(SeekFrom::Current(0)).unwrap();
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(StakeRegistration::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(StakeDelegation::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(PoolRegistration::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(PoolRetirement::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
...
impl Serialize for ConstrPlutusData {
    fn serialize<'se, W: Write>(
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.plutus_datas_encoding.clone())
                .unwrap_or_default()
                .to_len_sz(self.plutus_datas.len() as u64, force_canonical),
        )?;
    ...
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let (plutus_datas, plutus_datas_encoding) = (|| -> Result<_, DeserializeError> {
                ...
                while match len {
                    cbor_event::LenSz::Len(n, _) => plutus_datas_arr.len() < n as usize,
                    cbor_event::LenSz::Indefinite => true,
                } {
                    if raw.cbor_type()? == CBORType::Special {
                        assert_eq!(raw.special()?, CBORSpecial::Break);
                ...
                match raw.cbor_type()? {
                    CBORType::UnsignedInteger => match raw.unsigned_integer_sz()? {
                        (0, key_enc) => {
                            ...
                            let (tmp_key_0, tmp_key_0_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
...
impl Serialize for DatumOption {
    fn serialize<'se, W: Write>(
        ...
        match self {
            DatumOption::DatumOption0(datum_option0) => {
                datum_option0.serialize(serializer, force_canonical)
            }
            DatumOption::DatumOption1(datum_option1) => {
                datum_option1.serialize(serializer, force_canonical)
            }
        }
    }
}
...
impl Deserialize for DatumOption {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let initial_position = raw.as_mut_ref().seek(SeekFrom::Current(0)).unwrap();
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(DatumOption0::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(DatumOption1::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
...
impl DeserializeEmbeddedGroup for DatumOption0 {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        .map_err(|e| e.annotate("index_0"))?;
        let hash32 = (|| -> Result<_, DeserializeError> { Ok(DataHash::deserialize(raw)?) })()
    ...
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_tag_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.data_tag_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        let mut data_inner_se = Serializer::new_vec();
        data_inner_se.write_bytes_sz(
            &self.data,
            self.encodings
                .as_ref()
                .map(|encs| encs.data_encoding.clone())
                .unwrap_or_default()
                .to_str_len_sz(self.data.len() as u64, force_canonical),
        )?;
        ...
        serializer.write_bytes_sz(
            ...
            self.encodings
                .as_ref()
                .map(|encs| encs.data_bytes_encoding.clone())
                .unwrap_or_default()
                .to_str_len_sz(data_bytes.len() as u64, force_canonical),
        )?;
        self.encodings
            .as_ref()
            .map(|encs| encs.len_encoding)
...
impl DeserializeEmbeddedGroup for DatumOption1 {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        .map_err(|e| e.annotate("index_0"))?;
        let (data, data_tag_encoding, data_bytes_encoding, data_encoding) =
            (|| -> Result<_, DeserializeError> {
                Ok(match raw.tag_sz()? {
                    (24, tag_enc) => {
                        let (data_bytes, data_bytes_encoding) = raw.bytes_sz()?;
                        let mut inner_de =
                            &mut Deserializer::from(std::io::Cursor::new(data_bytes));
                        inner_de.bytes_sz().map(|(bytes, enc)| {
                            (
                                bytes,
                                Some(tag_enc),
                                StringEncoding::from(data_bytes_encoding),
                                StringEncoding::from(enc),
                            )
                        })?
                    }
...
impl Deserialize for ExUnitPrices {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            read_len.read_elems(2)?;
            let mem_price =
                (|| -> Result<_, DeserializeError> { Ok(PositiveInterval::deserialize(raw)?) })()
    ...
    fn serialize<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.mem_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.steps_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
    ...
    fn serialize<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.block_number_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.slot_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.block_body_size_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        ...
        (|| -> Result<_, DeserializeError> {
            ...
            let prev_hash = (|| -> Result<_, DeserializeError> {
                Ok(match raw.cbor_type()? != CBORType::Special {
                    true => Some(BlockHeaderHash::deserialize(raw)?),
                    false => {
            ...
            let (block_body_size, block_body_size_encoding) =
                (|| -> Result<_, DeserializeError> {
                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                })()
                .map_err(|e| e.annotate("block_body_size"))?;
            let block_body_hash =
                (|| -> Result<_, DeserializeError> { Ok(BlockBodyHash::deserialize(raw)?) })()
                    .map_err(|e| e.annotate("block_body_hash"))?;
            let operational_cert = (|| -> Result<_, DeserializeError> {
                Ok(OperationalCert::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            let protocol_version = (|| -> Result<_, DeserializeError> {
                Ok(ProtocolVersion::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
...
impl Serialize for I0OrI1 {
    fn serialize<'se, W: Write>(
        ...
        match self {
            I0OrI1::I0 { i0_encoding } => serializer
                .write_unsigned_integer_sz(0u64, fit_sz(0u64, *i0_encoding, force_canonical)),
            I0OrI1::I1 { i1_encoding } => serializer
                .write_unsigned_integer_sz(1u64, fit_sz(1u64, *i1_encoding, force_canonical)),
        }
    }
}
...
impl Deserialize for I0OrI1 {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            {
                Ok(i1_encoding) => return Ok(Self::I1 { i1_encoding }),
                Err(_) => raw
                    .as_mut_ref()
                    .seek(SeekFrom::Start(initial_position))
                    .unwrap(),
...
impl Serialize for Language {
    fn serialize<'se, W: Write>(
        ...
        match self {
            Language::I0 { i0_encoding } => serializer
                .write_unsigned_integer_sz(0u64, fit_sz(0u64, *i0_encoding, force_canonical)),
            Language::I1 { i1_encoding } => serializer
                .write_unsigned_integer_sz(1u64, fit_sz(1u64, *i1_encoding, force_canonical)),
        }
    }
}
    ...
    fn serialize<'se, W: Write>(
        ...
        serializer.write_map_sz(
            self.encodings
                ...
                .map(|encs| encs.index_1_encoding.clone())
                .unwrap_or_default()
                .to_len_sz(self.index_1.len() as u64, force_canonical),
        )?;
        let mut key_order = self
            .index_1
            .iter()
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.coin_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
...
impl Deserialize for MoveInstantaneousReward {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let mut read_len = CBORReadLen::new(len);
            read_len.read_elems(3)?;
            let index_0 = (|| -> Result<_, DeserializeError> { Ok(I0OrI1::deserialize(raw)?) })()
                .map_err(|e| e.annotate("index_0"))?;
            let (index_1, index_1_encoding) = (|| -> Result<_, DeserializeError> {
                let mut index_1_table = OrderedHashMap::new();
                let index_1_len = raw.map_sz()?;
                let index_1_encoding = index_1_len.into();
                while match index_1_len {
                    cbor_event::LenSz::Len(n, _) => index_1_table.len() < n as usize,
                    cbor_event::LenSz::Indefinite => true,
                } {
                    if raw.cbor_type()? == CBORType::Special {
                        assert_eq!(raw.special()?, CBORSpecial::Break);
                    ...
                    if index_1_table
                        .insert(index_1_key.clone(), index_1_value)
                        .is_some()
                    {
                        return Err(DeserializeFailure::DuplicateKey(Key::Str(String::from(
                            "some complicated/unsupported type",
...
impl DeserializeEmbeddedGroup for MultiHostName {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        .map_err(|e| e.annotate("index_0"))?;
        let dns_name = (|| -> Result<_, DeserializeError> { Ok(DnsName::deserialize(raw)?) })()
...
impl Serialize for NativeScript {
    fn serialize<'se, W: Write>(
        ...
        match self {
            ...
            NativeScript::InvalidBefore(invalid_before) => {
                invalid_before.serialize(serializer, force_canonical)
            }
            NativeScript::InvalidHereafter(invalid_hereafter) => {
                invalid_hereafter.serialize(serializer, force_canonical)
            }
        }
    }
}
...
impl Deserialize for NativeScript {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(InvalidBefore::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(InvalidHereafter::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
...
impl Serialize for NetworkId {
    fn serialize<'se, W: Write>(
        ...
        match self {
            NetworkId::I0 { i0_encoding } => serializer
                .write_unsigned_integer_sz(0u64, fit_sz(0u64, *i0_encoding, force_canonical)),
            NetworkId::I1 { i1_encoding } => serializer
                .write_unsigned_integer_sz(1u64, fit_sz(1u64, *i1_encoding, force_canonical)),
        }
    }
}
    ...
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.sequence_number_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.kes_period_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
...
impl Serialize for PlutusData {
    fn serialize<'se, W: Write>(
        ...
        match self {
            ...
            PlutusData::MapPlutusDataToPlutusData {
                map_plutus_data_to_plutus_data,
                map_plutus_data_to_plutus_data_encoding,
            } => {
                serializer.write_map_sz(
                    map_plutus_data_to_plutus_data_encoding
                        .to_len_sz(map_plutus_data_to_plutus_data.len() as u64, force_canonical),
                )?;
                let mut key_order = map_plutus_data_to_plutus_data
                    .iter()
                    .map(|(k, v)| {
                        let mut buf = cbor_event::se::Serializer::new_vec();
                        k.serialize(&mut buf, force_canonical)?;
            ...
            PlutusData::ArrPlutusData {
                arr_plutus_data,
                arr_plutus_data_encoding,
            } => {
                serializer.write_array_sz(
                    arr_plutus_data_encoding
                        .to_len_sz(arr_plutus_data.len() as u64, force_canonical),
                )?;
            ...
            PlutusData::BoundedBytes {
                ...
                &bounded_bytes,
                bounded_bytes_encoding.to_str_len_sz(bounded_bytes.len() as u64, force_canonical),
            ),
        }
    }
}
    ...
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                ...
                let map_plutus_data_to_plutus_data_encoding =
                    map_plutus_data_to_plutus_data_len.into();
                while match map_plutus_data_to_plutus_data_len {
                    cbor_event::LenSz::Len(n, _) => {
                        map_plutus_data_to_plutus_data_table.len() < n as usize
                    }
                    cbor_event::LenSz::Indefinite => true,
                } {
                    if raw.cbor_type()? == CBORType::Special {
                ...
                Ok((
                    map_plutus_data_to_plutus_data_table,
                    map_plutus_data_to_plutus_data_encoding,
                ))
            })(raw)
            {
                Ok((map_plutus_data_to_plutus_data, map_plutus_data_to_plutus_data_encoding)) => {
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                ...
                while match len {
                    cbor_event::LenSz::Len(n, _) => arr_plutus_data_arr.len() < n as usize,
                    cbor_event::LenSz::Indefinite => true,
                } {
                    if raw.cbor_type()? == CBORType::Special {
                        assert_eq!(raw.special()?, CBORSpecial::Break);
            ...
            {
                Ok((arr_plutus_data, arr_plutus_data_encoding)) => {
                    return Ok(Self::ArrPlutusData {
                        arr_plutus_data,
                        arr_plutus_data_encoding,
                    })
                }
            ...
            {
                Ok((bounded_bytes, bounded_bytes_encoding)) => {
                    return Ok(Self::BoundedBytes {
                        bounded_bytes,
                        bounded_bytes_encoding,
                    })
                }
    ...
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            Ok(PoolMetadata {
                url,
                pool_metadata_hash,
                encodings: Some(PoolMetadataEncoding { len_encoding }),
            })
        })()
    ...
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.pledge_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.cost_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.pool_owners_encoding.clone())
                .unwrap_or_default()
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.relays_encoding.clone())
                .unwrap_or_default()
...
impl DeserializeEmbeddedGroup for PoolParams {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        let reward_account =
            (|| -> Result<_, DeserializeError> { Ok(RewardAccount::deserialize(raw)?) })()
        ...
        let (pool_owners, pool_owners_encoding) = (|| -> Result<_, DeserializeError> {
            ...
            while match len {
                cbor_event::LenSz::Len(n, _) => pool_owners_arr.len() < n as usize,
                cbor_event::LenSz::Indefinite => true,
            } {
                if raw.cbor_type()? == CBORType::Special {
                    assert_eq!(raw.special()?, CBORSpecial::Break);
        ...
        let (relays, relays_encoding) = (|| -> Result<_, DeserializeError> {
            ...
            while match len {
                cbor_event::LenSz::Len(n, _) => relays_arr.len() < n as usize,
                cbor_event::LenSz::Indefinite => true,
            } {
                if raw.cbor_type()? == CBORType::Special {
                    assert_eq!(raw.special()?, CBORSpecial::Break);
...
impl DeserializeEmbeddedGroup for PoolRegistration {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        let pool_params = (|| -> Result<_, DeserializeError> {
            Ok(PoolParams::deserialize_as_embedded_group(
                raw, read_len, len,
            )?)
        })()
    ...
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.epoch_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
                    ...
                    if let Some(field) = &self.key_4 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_4_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_4_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_5 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_5_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_6 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_6_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_6_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_7 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_7_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_7_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_8 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_8_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_8_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_9 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_9_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_10 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_10_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_11 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_11_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_14 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_14_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_16 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_16_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_16_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_17 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_17_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_17_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_18 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_18_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_19 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_19_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_20 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_20_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_21 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_21_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_22 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_22_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_22_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_23 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_23_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_23_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                    ...
                    if let Some(field) = &self.key_24 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_24_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                            ...
                            *field,
                            fit_sz(
                                *field,
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_24_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                ...
                match raw.cbor_type()? {
                    CBORType::UnsignedInteger => match raw.unsigned_integer_sz()? {
                        ...
                        (4, key_enc) => {
                            ...
                            let (tmp_key_4, tmp_key_4_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (6, key_enc) => {
                            ...
                            let (tmp_key_6, tmp_key_6_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (7, key_enc) => {
                            ...
                            let (tmp_key_7, tmp_key_7_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (8, key_enc) => {
                            ...
                            let (tmp_key_8, tmp_key_8_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (16, key_enc) => {
                            ...
                            let (tmp_key_16, tmp_key_16_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (17, key_enc) => {
                            ...
                            let (tmp_key_17, tmp_key_17_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (22, key_enc) => {
                            ...
                            let (tmp_key_22, tmp_key_22_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (23, key_enc) => {
                            ...
                            let (tmp_key_23, tmp_key_23_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
                        ...
                        (24, key_enc) => {
                            ...
                            let (tmp_key_24, tmp_key_24_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    Ok(raw.unsigned_integer_sz().map(|(x, enc)| (x, Some(enc)))?)
                                })()
    ...
    fn serialize<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.numerator_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.denominator_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
    ...
    fn serialize<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.index_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
...
impl Serialize for RedeemerTag {
    fn serialize<'se, W: Write>(
        ...
        match self {
            RedeemerTag::I0 { i0_encoding } => serializer
                .write_unsigned_integer_sz(0u64, fit_sz(0u64, *i0_encoding, force_canonical)),
            RedeemerTag::I1 { i1_encoding } => serializer
                .write_unsigned_integer_sz(1u64, fit_sz(1u64, *i1_encoding, force_canonical)),
            RedeemerTag::I2 { i2_encoding } => serializer
                .write_unsigned_integer_sz(2u64, fit_sz(2u64, *i2_encoding, force_canonical)),
            RedeemerTag::I3 { i3_encoding } => serializer
...
impl Deserialize for RedeemerTag {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            {
                Ok(i2_encoding) => return Ok(Self::I2 { i2_encoding }),
                Err(_) => raw
                    .as_mut_ref()
                    .seek(SeekFrom::Start(initial_position))
                    .unwrap(),
            ...
            {
                Ok(i3_encoding) => return Ok(Self::I3 { i3_encoding }),
                Err(_) => raw
                    .as_mut_ref()
                    .seek(SeekFrom::Start(initial_position))
                    .unwrap(),
...
impl Deserialize for Relay {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let initial_position = raw.as_mut_ref().seek(SeekFrom::Current(0)).unwrap();
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(SingleHostAddr::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(SingleHostName::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(MultiHostName::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
...
impl Deserialize for RequiredSigners {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            Ok(RequiredSigners {
                addr_keyhash,
                encodings: Some(RequiredSignersEncoding { len_encoding }),
            })
        })()
...
impl Deserialize for Script {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let initial_position = raw.as_mut_ref().seek(SeekFrom::Current(0)).unwrap();
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(Script0::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(Script1::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(Script2::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
...
impl DeserializeEmbeddedGroup for Script0 {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        .map_err(|e| e.annotate("index_0"))?;
        let native_script =
            (|| -> Result<_, DeserializeError> { Ok(NativeScript::deserialize(raw)?) })()
...
impl SerializeEmbeddedGroup for Script1 {
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_bytes_sz(
            &self.plutus_v1_script,
            self.encodings
                .as_ref()
                .map(|encs| encs.plutus_v1_script_encoding.clone())
                .unwrap_or_default()
                .to_str_len_sz(self.plutus_v1_script.len() as u64, force_canonical),
        )?;
        self.encodings
            .as_ref()
            .map(|encs| encs.len_encoding)
...
impl SerializeEmbeddedGroup for Script2 {
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_bytes_sz(
            &self.plutus_v2_script,
            self.encodings
                .as_ref()
                .map(|encs| encs.plutus_v2_script_encoding.clone())
                .unwrap_or_default()
                .to_str_len_sz(self.plutus_v2_script.len() as u64, force_canonical),
        )?;
        self.encodings
            .as_ref()
            .map(|encs| encs.len_encoding)
...
impl SerializeEmbeddedGroup for ScriptAll {
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.native_scripts_encoding.clone())
                .unwrap_or_default()
...
impl DeserializeEmbeddedGroup for ScriptAll {
    fn deserialize_as_embedded_group<R: BufRead + Seek>(
        ...
        let (native_scripts, native_scripts_encoding) = (|| -> Result<_, DeserializeError> {
            ...
            while match len {
                cbor_event::LenSz::Len(n, _) => native_scripts_arr.len() < n as usize,
                cbor_event::LenSz::Indefinite => true,
            } {
                if raw.cbor_type()? == CBORType::Special {
                    assert_eq!(raw.special()?, CBORSpecial::Break);
    ...
    fn serialize_as_embedded_group<'se, W: Write>(
        ...
        serializer.write_unsigned_integer_sz(
            ...
            fit_sz(
                ...
                self.encodings
                    .as_ref()
                    .map(|encs| encs.n_encoding.clone())
                    .unwrap_or_default(),
                force_canonical,
            ),
        )?;
...
impl Serialize for ShelleyMaAuxData {
    fn serialize<'se, W: Write>(
        ...
        serializer.write_map_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.transaction_metadata_encoding.clone())
                .unwrap_or_default()
        ...
        serializer.write_array_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.auxiliary_scripts_encoding.clone())
                .unwrap_or_default()
        ...
        (|| -> Result<_, DeserializeError> {
            ...
            let (
                ...
                while match transaction_metadata_len {
                    cbor_event::LenSz::Len(n, _) => transaction_metadata_table.len() < n as usize,
                    cbor_event::LenSz::Indefinite => true,
                } {
                    if raw.cbor_type()? == CBORType::Special {
                        assert_eq!(raw.special()?, CBORSpecial::Break);
                    ...
                    if transaction_metadata_table
                        .insert(transaction_metadata_key.clone(), transaction_metadata_value)
                        .is_some()
                    {
                        return Err(DeserializeFailure::DuplicateKey(Key::Str(String::from(
                            "some complicated/unsupported type",
                    ...
                    transaction_metadata_key_encodings.insert(
                        transaction_metadata_key.clone(),
                        transaction_metadata_key_encoding,
                    );
                }
                Ok((
            ...
            let (auxiliary_scripts, auxiliary_scripts_encoding) =
                (|| -> Result<_, DeserializeError> {
                    ...
                    while match len {
                        cbor_event::LenSz::Len(n, _) => auxiliary_scripts_arr.len() < n as usize,
                        cbor_event::LenSz::Indefinite => true,
                    } {
                        if raw.cbor_type()? == CBORType::Special {
                            assert_eq!(raw.special()?, CBORSpecial::Break);
                ...
                *x as u64,
                fit_sz(
                    *x as u64,
                    self.encodings
                        .as_ref()
                        .map(|encs| encs.port_encoding.clone())
                        .unwrap_or_default(),
                    force_canonical,
                ),
            ),
    ...
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            let transaction_body =
                (|| -> Result<_, DeserializeError> { Ok(TransactionBody::deserialize(raw)?) })()
            ...
            let index_2 = (|| -> Result<_, DeserializeError> { Ok(raw.bool()?) })()
            ...
            match field_index {
                0 => {
                    ...
                    serializer.write_array_sz(
                        self.encodings
                            ...
                            .map(|encs| encs.key_0_encoding.clone())
                            .unwrap_or_default()
                            .to_len_sz(self.key_0.len() as u64, force_canonical),
                    )?;
                ...
                1 => {
                    ...
                    serializer.write_array_sz(
                        self.encodings
                            ...
                            .map(|encs| encs.key_1_encoding.clone())
                            .unwrap_or_default()
                            .to_len_sz(self.key_1.len() as u64, force_canonical),
                    )?;
                ...
                5 => {
                    if let Some(field) = &self.key_5 {
                        ...
                        for (key_bytes, key, value) in key_order {
                            serializer.write_raw_bytes(&key_bytes)?;
                            let key_5_value_encoding = self
                                .encodings
                                .as_ref()
                                .and_then(|encs| encs.key_5_value_encodings.get(key))
                                .map(|e| e.clone())
                                .unwrap_or_else(|| None);
                            serializer.write_unsigned_integer_sz(
                                *value,
                                fit_sz(*value, key_5_value_encoding, force_canonical),
                            )?;
                        }
                        self.encodings
                            .as_ref()
                ...
                9 => {
                    if let Some(field) = &self.key_9 {
                        ...
                        serializer.write_map_sz(
                            self.encodings
                                .as_ref()
                                .map(|encs| encs.key_9_encoding.clone())
                                .unwrap_or_default()
                                .to_len_sz(field.len() as u64, force_canonical),
                        )?;
                        let mut key_order = field
                        ...
                        for (key_bytes, key, value) in key_order {
                            serializer.write_raw_bytes(&key_bytes)?;
                            let (key_9_value_encoding, key_9_value_value_encodings) = self
                                .encodings
                                .as_ref()
                                .and_then(|encs| encs.key_9_value_encodings.get(key))
                                .map(|e| e.clone())
                                .unwrap_or_else(|| (LenEncoding::default(), BTreeMap::new()));
                            serializer.write_map_sz(
                                key_9_value_encoding.to_len_sz(value.len() as u64, force_canonical),
                            )?;
                            ...
                            for (key_bytes, key, value) in key_order {
                                serializer.write_raw_bytes(&key_bytes)?;
                                let key_9_value_value_encoding = key_9_value_value_encodings
                                    .get(key)
                                    .map(|e| e.clone())
                                    .unwrap_or_else(|| None);
                                if *value >= 0 {
                    ...
                    if let Some(field) = &self.key_13 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_13_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                        serializer.write_array_sz(
                            self.encodings
                                .as_ref()
                                .map(|encs| encs.key_13_encoding.clone())
                                .unwrap_or_default()
                                .to_len_sz(field.len() as u64, force_canonical),
                        )?;
                        for element in field.iter() {
                    ...
                    if let Some(field) = &self.key_15 {
                        serializer.write_unsigned_integer_sz(
                            ...
                            fit_sz(
                                ...
                                self.encodings
                                    .as_ref()
                                    .map(|encs| encs.key_15_key_encoding.clone())
                                    .unwrap_or_default(),
                                force_canonical,
                            ),
                        )?;
                ...
                16 => {
                    if let Some(field) = &self.key_18 {
                        ...
                        serializer.write_array_sz(
                            self.encodings
                                .as_ref()
                                .map(|encs| encs.key_18_encoding.clone())
                                .unwrap_or_default()
                                .to_len_sz(field.len() as u64, force_canonical),
                        )?;
                        for element in field.iter() {
                ...
                match raw.cbor_type()? {
                    CBORType::UnsignedInteger => match raw.unsigned_integer_sz()? {
                        ...
                        (5, key_enc) => {
                            ...
                            let (tmp_key_5, tmp_key_5_encoding, tmp_key_5_value_encodings) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    ...
                                    let mut key_5_value_encodings = BTreeMap::new();
                                    while match key_5_len {
                                        cbor_event::LenSz::Len(n, _) => {
                                            key_5_table.len() < n as usize
                                        }
                                        cbor_event::LenSz::Indefinite => true,
                                    } {
                                        if raw.cbor_type()? == CBORType::Special {
                                        ...
                                        let (key_5_value, key_5_value_encoding) = raw
                                            .unsigned_integer_sz()
                                            .map(|(x, enc)| (x, Some(enc)))?;
                                        if key_5_table
                                            .insert(key_5_key.clone(), key_5_value)
                                            .is_some()
                                        {
                                            return Err(DeserializeFailure::DuplicateKey(
                                                Key::Str(String::from(
                                        ...
                                        key_5_value_encodings
                                            .insert(key_5_key.clone(), key_5_value_encoding);
                                    }
                        ...
                        (9, key_enc) => {
                            ...
                            let (tmp_key_9, tmp_key_9_encoding, tmp_key_9_value_encodings) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    ...
                                    let mut key_9_value_encodings = BTreeMap::new();
                                    while match key_9_len {
                                        cbor_event::LenSz::Len(n, _) => {
                                            key_9_table.len() < n as usize
                                        }
                                        cbor_event::LenSz::Indefinite => true,
                                    } {
                                        if raw.cbor_type()? == CBORType::Special {
                                        ...
                                        while match key_9_value_len {
                                            cbor_event::LenSz::Len(n, _) => {
                                                key_9_value_table.len() < n as usize
                                            }
                                            cbor_event::LenSz::Indefinite => true,
                                        } {
                                            if raw.cbor_type()? == CBORType::Special {
                                            ...
                                            let (key_9_value_value, key_9_value_value_encoding) =
                                                match raw.cbor_type()? {
                                            ...
                                            if key_9_value_table
                                                .insert(key_9_value_key.clone(), key_9_value_value)
                                                .is_some()
                                            {
                                                return Err(DeserializeFailure::DuplicateKey(
                                                    Key::Str(String::from(
                                            ...
                                            key_9_value_value_encodings.insert(
                                                key_9_value_key.clone(),
                                                key_9_value_value_encoding,
                                            );
                                        }
                                        let (
                                            key_9_value,
                                            key_9_value_encoding,
                                            key_9_value_value_encodings,
                                        ) = (
                                            key_9_value_table,
                                            key_9_value_encoding,
                                            key_9_value_value_encodings,
                                        ...
                                        if key_9_table
                                            .insert(key_9_key.clone(), key_9_value)
                                            .is_some()
                                        {
                                            return Err(DeserializeFailure::DuplicateKey(
                                                Key::Str(String::from(
                                        ...
                                        key_9_value_encodings.insert(
                                            key_9_key.clone(),
                                            (key_9_value_encoding, key_9_value_value_encodings),
                                        );
                                    }
                        ...
                        (13, key_enc) => {
                            ...
                            let (tmp_key_13, tmp_key_13_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                        ...
                        (18, key_enc) => {
                            ...
                            let (tmp_key_18, tmp_key_18_encoding) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
            ...
            match field_index {
                ...
                6 => {
                    if let Some(field) = &self.key_6 {
                        ...
                        for (i, element) in field.iter().enumerate() {
                            let key_6_elem_encoding = self
                                .encodings
                                .as_ref()
                                .and_then(|encs| encs.key_6_elem_encodings.get(i))
                                .map(|e| e.clone())
                                .unwrap_or_else(|| StringEncoding::default());
                            serializer.write_bytes_sz(
                                &element,
                ...
                match raw.cbor_type()? {
                    CBORType::UnsignedInteger => match raw.unsigned_integer_sz()? {
                        ...
                        (6, key_enc) => {
                            ...
                            let (tmp_key_6, tmp_key_6_encoding, tmp_key_6_elem_encodings) =
                                (|| -> Result<_, DeserializeError> {
                                    read_len.read_elems(1)?;
                                    ...
                                    while match len {
                                        ...
                                        let (key_6_elem, key_6_elem_encoding) =
                                            raw.bytes_sz().map(|(bytes, enc)| {
                                                (bytes, StringEncoding::from(enc))
                                            })?;
...
impl Serialize for Update {
    fn serialize<'se, W: Write>(
        ...
        serializer.write_map_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.proposed_protocol_parameter_updates_encoding.clone())
                .unwrap_or_default()
                .to_len_sz(
...
impl Serialize for Value {
    fn serialize<'se, W: Write>(
        ...
        serializer.write_map_sz(
            self.encodings
                .as_ref()
                .map(|encs| encs.multiasset_encoding.clone())
                .unwrap_or_default()
...
impl Deserialize for Value {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            .map_err(|e| e.annotate("coin"))?;
            let (multiasset, multiasset_encoding, multiasset_value_encodings) =
                (|| -> Result<_, DeserializeError> {
                    ...
                    while match multiasset_len {
                        cbor_event::LenSz::Len(n, _) => multiasset_table.len() < n as usize,
                        cbor_event::LenSz::Indefinite => true,
                    } {
                        if raw.cbor_type()? == CBORType::Special {
                            assert_eq!(raw.special()?, CBORSpecial::Break);
                        ...
                        while match multiasset_value_len {
                            cbor_event::LenSz::Len(n, _) => {
                                multiasset_value_table.len() < n as usize
                            }
                            cbor_event::LenSz::Indefinite => true,
                        } {
                            if raw.cbor_type()? == CBORType::Special {
                            ...
                            multiasset_value_value_encodings.insert(
                                multiasset_value_key.clone(),
                                multiasset_value_value_encoding,
                            );
                        }
                        let (
                            multiasset_value,
...
impl Deserialize for Nonce {
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            match (|raw: &mut Deserializer<_>| -> Result<_, DeserializeError> {
                Ok(Nonce1::deserialize_as_embedded_group(
                    raw,
                    &mut read_len,
                    len,
                )?)
    ...
    fn deserialize<R: BufRead + Seek>(raw: &mut Deserializer<R>) -> Result<Self, DeserializeError> {
        (|| -> Result<_, DeserializeError> {
            ...
            Ok(Vkeywitness {
                vkey,
                signature,
                encodings: Some(VkeywitnessEncoding { len_encoding }),
            })
        })()
